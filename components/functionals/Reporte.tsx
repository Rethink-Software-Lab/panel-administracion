...
import { ClipboardX, CloudOff, FolderSearch } from 'lucide-react';
    ...
    >
      {data &&
        (data?.productos?.length > 0 ? (
          ...
          <div className="flex flex-1 p-4 h-full items-center justify-center rounded-lg bg-background border border-dashed shadow-sm">
