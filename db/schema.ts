...
export const inventarioEntradaalmacen = pgTable("inventario_entradaalmacen", {
	...
	index("inventario_entradaalmacen_proveedor_id_28738cfb").using("btree", table.proveedorId.asc().nullsLast().op("int8_ops")),
...
export const inventarioTransacciones = pgTable("inventario_transacciones", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	index("inventario_transacciones_entrada_cafeteria_id_1ae4637b").using("btree", table.entradaCafeteriaId.asc().nullsLast().op("int8_ops")),
	index("inventario_transacciones_entrada_id_d57aa1ad").using("btree", table.entradaId.asc().nullsLast().op("int8_ops")),
	index("inventario_transacciones_venta_cafeteria_id_4458ecb0").using("btree", table.ventaCafeteriaId.asc().nullsLast().op("int8_ops")),
	index("inventario_transacciones_venta_id_156db011").using("btree", table.ventaId.asc().nullsLast().op("int8_ops")),
	index("inventario_transferenciastarjetas_cuenta_id_a32c09b5").using("btree", table.cuentaId.asc().nullsLast().op("int8_ops")),
...
export const inventarioEntradasCafeteria = pgTable("inventario_entradas_cafeteria", {
	...
	proveedorNoCuentaMayorista: varchar("proveedor_no_cuenta_mayorista", { length: 30 }),
	proveedorNombre: varchar("proveedor_nombre", { length: 100 }),
	proveedorTelefono: varchar("proveedor_telefono", { length: 10 }),
}, (table) => [
	index("inventario_entradas_cafeteria_proveedor_id_3ee8125c").using("btree", table.proveedorId.asc().nullsLast().op("int8_ops")),
...
export const inventarioCuentas = pgTable("inventario_cuentas", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "inventario_cuentas_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	nombre: varchar({ length: 50 }).notNull(),
	tipo: varchar({ length: 30 }).notNull(),
...
export const inventarioProveedor = pgTable("inventario_proveedor", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "inventario_proveedor_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
...
export const inventarioHistorialpreciocostosalon = pgTable("inventario_historialpreciocostosalon", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "inventario_historialpreciocostosalon_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	...
	index("inventario_historialpreciocostosalon_producto_info_id_c47d9e6d").using("btree", table.productoInfoId.asc().nullsLast().op("int8_ops")),
	index("inventario_historialpreciocostosalon_usuario_id_5305b961").using("btree", table.usuarioId.asc().nullsLast().op("int8_ops")),
	foreignKey({
			columns: [table.usuarioId],
			foreignColumns: [inventarioUser.id],
...
export const inventarioHistorialprecioventasalon = pgTable("inventario_historialprecioventasalon", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "inventario_historialprecioventasalon_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	precio: numeric({ precision: 7, scale:  2 }).notNull(),
	fechaInicio: timestamp("fecha_inicio", { withTimezone: true, mode: 'string' }).notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	usuarioId: bigint("usuario_id", { mode: "number" }),
	...
	index("inventario_historialprecioventasalon_producto_info_id_768111cc").using("btree", table.productoInfoId.asc().nullsLast().op("int8_ops")),
	index("inventario_historialprecioventasalon_usuario_id_3c4f4b75").using("btree", table.usuarioId.asc().nullsLast().op("int8_ops")),
	foreignKey({
			columns: [table.usuarioId],
			foreignColumns: [inventarioUser.id],
...
export const inventarioHistorialpreciocostocafeteria = pgTable("inventario_historialpreciocostocafeteria", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "inventario_historialpreciocostocafeteria_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	precio: numeric({ precision: 7, scale:  2 }).notNull(),
	fechaInicio: timestamp("fecha_inicio", { withTimezone: true, mode: 'string' }).notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	index("inventario_historialpreciocostocafeteria_producto_id_a98d6f93").using("btree", table.productoId.asc().nullsLast().op("int8_ops")),
	index("inventario_historialpreciocostocafeteria_usuario_id_93aaf4ef").using("btree", table.usuarioId.asc().nullsLast().op("int8_ops")),
	foreignKey({
			columns: [table.productoId],
			foreignColumns: [inventarioProductosCafeteria.id],
...
export const inventarioHistorialprecioventacafeteria = pgTable("inventario_historialprecioventacafeteria", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "inventario_historialprecioventacafeteria_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	precio: numeric({ precision: 7, scale:  2 }).notNull(),
	fechaInicio: timestamp("fecha_inicio", { withTimezone: true, mode: 'string' }).notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	productoId: bigint("producto_id", { mode: "number" }),
	...
	index("inventario_historialprecioventacafeteria_producto_id_1e98c217").using("btree", table.productoId.asc().nullsLast().op("int8_ops")),
	index("inventario_historialprecioventacafeteria_usuario_id_69c2b8bf").using("btree", table.usuarioId.asc().nullsLast().op("int8_ops")),
	foreignKey({
			columns: [table.productoId],
			foreignColumns: [inventarioProductosCafeteria.id],
...
export const inventarioPrecioelaboracion = pgTable("inventario_precioelaboracion", {
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	id: bigint({ mode: "number" }).primaryKey().generatedByDefaultAsIdentity({ name: "inventario_precioelaboracion_id_seq", startWith: 1, increment: 1, minValue: 1, maxValue: 9223372036854775807, cache: 1 }),
	precio: numeric({ precision: 7, scale:  2 }).notNull(),
	fechaInicio: timestamp("fecha_inicio", { withTimezone: true, mode: 'string' }).notNull(),
	// You can use { mode: "bigint" } if numbers are exceeding js number limitations
	...
	index("inventario_precioelaboracion_elaboracion_id_ad82128f").using("btree", table.elaboracionId.asc().nullsLast().op("int8_ops")),
	index("inventario_precioelaboracion_usuario_id_427eae1c").using("btree", table.usuarioId.asc().nullsLast().op("int8_ops")),
	foreignKey({
