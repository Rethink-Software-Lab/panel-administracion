...
import { djangoContentType, authPermission, authGroup, authGroupPermissions, inventarioAreaventa, inventarioVentas, inventarioUser, inventarioUserGroups, inventarioUserUserPermissions, inventarioSalidaalmacen, inventarioProducto, inventarioProductoinfo, inventarioSalidaalmacenrevoltosa, inventarioEntradaalmacen, inventarioProveedor, inventarioCategorias, inventarioImage, djangoAdminLog, inventarioTransferencia, inventarioTransferenciaProductos, inventarioAjusteinventario, inventarioAjusteinventarioProductos, inventarioGastos, inventarioElaboraciones, inventarioElaboracionesIngredientesCantidad, inventarioIngredienteCantidad, inventarioProductosCafeteria, inventarioTransacciones, inventarioCuentas, inventarioVentasCafeteria, inventarioEntradasCafeteria, inventarioElaboracionesVentasCafeteria, inventarioProductosEntradasCafeteria, inventarioEntradasCafeteriaProductos, inventarioVentasCafeteriaElaboraciones, inventarioVentasCafeteriaProductos, inventarioProductosVentasCafeteria, inventarioInventarioAlmacenCafeteria, inventarioInventarioAreaCafeteria, inventarioProductosSalidasCafeteria, inventarioSalidasCafeteria, inventarioSalidasCafeteriaProductos, inventarioElaboracionesSalidasAlmacenCafeteria, inventarioSalidasCafeteriaElaboraciones, inventarioCuentacasa, inventarioCuentacasaElaboraciones, inventarioElaboracionesCantidadCuentaCasa, inventarioCuentacasaProductos, inventarioProductosCantidadCuentaCasa, inventarioMermacafeteria, inventarioMermacafeteriaElaboraciones, inventarioElaboracionesCantidadMerma, inventarioMermacafeteriaProductos, inventarioProductosCantidadMerma, inventarioHistorialpreciocostosalon, inventarioHistorialprecioventasalon, inventarioHistorialpreciocostocafeteria, inventarioHistorialprecioventacafeteria } from "./schema";
...
export const inventarioUserRelations = relations(inventarioUser, ({one, many}) => ({
	...
	inventarioHistorialpreciocostosalons: many(inventarioHistorialpreciocostosalon),
	inventarioHistorialprecioventasalons: many(inventarioHistorialprecioventasalon),
	inventarioHistorialpreciocostocafeterias: many(inventarioHistorialpreciocostocafeteria),
	inventarioHistorialprecioventacafeterias: many(inventarioHistorialprecioventacafeteria),
}));
...
export const inventarioProveedorRelations = relations(inventarioProveedor, ({many}) => ({
	inventarioEntradaalmacens: many(inventarioEntradaalmacen),
	inventarioEntradasCafeterias: many(inventarioEntradasCafeteria),
}));
...
export const inventarioHistorialpreciocostosalonRelations = relations(inventarioHistorialpreciocostosalon, ({one}) => ({
	inventarioUser: one(inventarioUser, {
...
export const inventarioHistorialprecioventasalonRelations = relations(inventarioHistorialprecioventasalon, ({one}) => ({
	inventarioUser: one(inventarioUser, {
...
export const inventarioHistorialpreciocostocafeteriaRelations = relations(inventarioHistorialpreciocostocafeteria, ({one}) => ({
	inventarioProductosCafeteria: one(inventarioProductosCafeteria, {
...
export const inventarioHistorialprecioventacafeteriaRelations = relations(inventarioHistorialprecioventacafeteria, ({one}) => ({
	inventarioProductosCafeteria: one(inventarioProductosCafeteria, {
